...
# Ask for n and m from user input
n = int(input("Number of symbol nodes (n): "))
m = int(input("Number of check nodes (m): "))

# Validation & error handling

# Validate the number of symbol node degrees provided (should match number of symbol nodes)
while True:
...
# Validate given degree values of symbol nodes (should not exceed number of check nodes)
while True:
...
# Create & visualize final Tanner Graph
...
print("Final Parity Check Matrix:")
print_parity_check_matrix(graph, s_nodes, c_nodes)
...
# Create & visualize Subgraph of chosen symbol node by user at provided depth
