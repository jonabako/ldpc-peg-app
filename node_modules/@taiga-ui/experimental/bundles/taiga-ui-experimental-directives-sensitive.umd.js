(function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('rxjs/operators')) :
        typeof define === 'function' && define.amd ? define('@taiga-ui/experimental/directives/sensitive', ['exports', '@angular/core', '@taiga-ui/cdk', 'rxjs/operators'], factory) :
        (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].experimental = global["taiga-ui"].experimental || {}, global["taiga-ui"].experimental.directives = global["taiga-ui"].experimental.directives || {}, global["taiga-ui"].experimental.directives.sensitive = {}), global.ng.core, global.i1, global.rxjs.operators));
        ...
        ***************************************************************************** */
        ...
        var TuiSensitiveDirective = /** @class */ (function () {
            function TuiSensitiveDirective(directiveStyles, resize$) {
                this.resize$ = resize$;
                this.tuiSensitive = false;
                this.offset = Math.round(Math.random() * 10) * 10;
                this.height$ = this.resize$.pipe(operators.map(function (_a) {
                    ...
                    var _b = __read(_a, 2), rows = _b[0], height = _b[1];
        ...
        TuiSensitiveDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSensitiveDirective, deps: [{ token: i1.TuiDirectiveStylesService }, { token: i1.TuiResizeService }], target: i0__namespace.ɵɵFactoryTarget.Directive });
        TuiSensitiveDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiSensitiveDirective, selector: "[tuiSensitive]", inputs: { tuiSensitive: "tuiSensitive" }, host: { listeners: { "$.style.--t-mask-height.px": "height$" }, properties: { "style.--t-offset.px": "offset", "$.style.--t-mask-height.px": "height$", "class.tui-sensitive": "tuiSensitive" } }, providers: [i1.TuiResizeService, i1.TuiDestroyService], ngImport: i0__namespace });
        i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSensitiveDirective, decorators: [{
                    ...
                    args: [{
                            ...
                            providers: [i1.TuiResizeService, i1.TuiDestroyService],
                            host: {
                ...
                return [{ type: i1__namespace.TuiDirectiveStylesService, decorators: [{
                            ...
                            }] }, { type: i1__namespace.TuiResizeService, decorators: [{
                                type: i0.Inject,
        ...
        TuiSensitiveModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSensitiveModule, declarations: [TuiSensitiveDirective, TuiSensitiveComponent], exports: [TuiSensitiveDirective] });
