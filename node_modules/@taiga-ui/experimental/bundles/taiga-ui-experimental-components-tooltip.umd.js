(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TUI_TOOLTIP_DEFAULT_OPTIONS = {
        icons: 'tuiIconHelpCircle',
    };
    var TUI_TOOLTIP_OPTIONS = cdk.tuiCreateToken(TUI_TOOLTIP_DEFAULT_OPTIONS);
    function tuiTooltipOptionsProvider(options) {
        return cdk.tuiProvideOptions(TUI_TOOLTIP_OPTIONS, options, TUI_TOOLTIP_DEFAULT_OPTIONS);
    }
    ...
    var TuiTooltipComponent = /** @class */ (function (_super) {
        ...
        function TuiTooltipComponent(destroy$, mode$, options, tooltipOptions, platform, iconAppearance) {
            var _this = _super.call(this, options) || this;
            _this.tooltipOptions = tooltipOptions;
            _this.platform = platform;
            _this.iconAppearance = iconAppearance;
            _this.mode = null;
            _this.describeId = '';
        ...
        Object.defineProperty(TuiTooltipComponent.prototype, "tooltipIcon", {
            get: function () {
                var icons = this.tooltipOptions.icons;
                return cdk.tuiIsString(icons) ? icons : icons[this.platform];
            },
            enumerable: false,
            configurable: true
        });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiTooltipComponent, decorators: [{
                ...
                args: [{
                        ...
                        providers: [cdk.TuiDestroyService, i4.MODE_PROVIDER],
            ...
            return [{ type: i6__namespace.Observable, decorators: [{
                        ...
                        }] }, { type: i3__namespace.TuiAppearanceDirective, decorators: [{
                            type: i0.Optional
                        }, {
                            type: i0.Inject,
                            args: [i3.TuiAppearanceDirective]
                        }] }];
        }, propDecorators: { driver$: [{
                    type: i0.ViewChild,
                    args: [i4.TuiHintHoverDirective]
                }], describeId: [{
                    type: i0.Input
                }], context: [{
                    type: i0.Input
    ...
    exports.TUI_TOOLTIP_DEFAULT_OPTIONS = TUI_TOOLTIP_DEFAULT_OPTIONS;
    exports.TUI_TOOLTIP_OPTIONS = TUI_TOOLTIP_OPTIONS;
    exports.TuiTooltipComponent = TuiTooltipComponent;
    exports.TuiTooltipModule = TuiTooltipModule;
    exports.tuiTooltipOptionsProvider = tuiTooltipOptionsProvider;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=taiga-ui-experimental-components-tooltip.umd.js.map
