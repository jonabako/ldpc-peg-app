...
declare type MONTHS_ARRAY = [string, string, string, string, string, string, string, string, string, string, string, string];
...
export interface TuiLanguage extends TuiLanguageCore, TuiLanguageKit, TuiLanguageCommerce, TuiLanguageTable, TuiLanguageEditor, TuiLanguagePreview, TuiLanguageMeta {
}
export {};
