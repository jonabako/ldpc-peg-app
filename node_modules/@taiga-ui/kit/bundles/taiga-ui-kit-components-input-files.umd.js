(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    var TUI_INPUT_FILES_OPTIONS = i2.tuiCreateToken(TUI_INPUT_FILES_DEFAULT_OPTIONS);
    function tuiInputFilesOptionsProvider(options) {
        return i2.tuiProvideOptions(TUI_INPUT_FILES_OPTIONS, options, TUI_INPUT_FILES_DEFAULT_OPTIONS);
    }
    ...
    TuiInputFilesDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiInputFilesDirective, deps: [{ token: i0.forwardRef(function () { return TuiInputFilesComponent; }) }, { token: i0.ElementRef }, { token: i2.TuiIdService }, { token: TUI_INPUT_FILES_OPTIONS }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiInputFilesDirective, decorators: [{
            ...
            return [{ type: TuiInputFilesComponent, decorators: [{
                            type: i0.Inject,
                            args: [i0.forwardRef(function () { return TuiInputFilesComponent; })]
