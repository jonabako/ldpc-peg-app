(function (global, factory) {
	...
	Object.keys(badgedContent).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return badgedContent[k]; }
		});
	});
	Object.keys(breadcrumbs).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return breadcrumbs[k]; }
		});
	});
	Object.keys(calendarMonth).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return calendarMonth[k]; }
		});
	});
	Object.keys(calendarRange).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return calendarRange[k]; }
		});
	});
	...
	Object.keys(checkboxBlock).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return checkboxBlock[k]; }
		});
	});
	Object.keys(checkboxLabeled).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return checkboxLabeled[k]; }
		});
	});
	...
	Object.keys(dataListWrapper).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
	...
	Object.keys(inputCopy).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputCopy[k]; }
		});
	});
	Object.keys(inputCount).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputCount[k]; }
		});
	});
	Object.keys(inputDate).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputDate[k]; }
		});
	});
	Object.keys(inputDateMulti).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputDateMulti[k]; }
		});
	});
	Object.keys(inputDateRange).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputDateRange[k]; }
		});
	});
	Object.keys(inputDateTime).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputDateTime[k]; }
		});
	});
	Object.keys(inputFiles).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputFiles[k]; }
		});
	});
	Object.keys(inputInline).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputInline[k]; }
		});
	});
	Object.keys(inputMonth).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputMonth[k]; }
		});
	});
	Object.keys(inputMonthRange).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputMonthRange[k]; }
		});
	});
	Object.keys(inputNumber).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputNumber[k]; }
		});
	});
	Object.keys(inputPassword).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputPassword[k]; }
		});
	});
	Object.keys(inputPhone).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputPhone[k]; }
		});
	});
	Object.keys(inputPhoneInternational).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputPhoneInternational[k]; }
		});
	});
	Object.keys(inputRange).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputRange[k]; }
		});
	});
	Object.keys(inputSlider).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputSlider[k]; }
		});
	});
	Object.keys(inputTag).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return inputTag[k]; }
		});
	});
	Object.keys(inputTime).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
	...
	Object.keys(island).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return island[k]; }
		});
	});
	Object.keys(itemsWithMore).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return itemsWithMore[k]; }
		});
	});
	Object.keys(lineClamp).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return lineClamp[k]; }
		});
	});
	Object.keys(markerIcon).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return markerIcon[k]; }
		});
	});
	...
	Object.keys(multiSelectOption).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return multiSelectOption[k]; }
		});
	});
	...
	Object.keys(pdfViewer).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return pdfViewer[k]; }
		});
	});
	...
	Object.keys(radioBlock).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return radioBlock[k]; }
		});
	});
	...
	Object.keys(radioLabeled).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return radioLabeled[k]; }
		});
	});
	Object.keys(radioList).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return radioList[k]; }
		});
	});
	Object.keys(range).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return range[k]; }
		});
	});
	...
	Object.keys(routableDialog).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return routableDialog[k]; }
		});
	});
	...
	Object.keys(selectOption).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return selectOption[k]; }
		});
	});
...
//# sourceMappingURL=taiga-ui-kit-components.umd.js.map
