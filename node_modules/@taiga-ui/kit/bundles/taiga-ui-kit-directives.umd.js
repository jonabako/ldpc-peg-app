(function (global, factory) {
	...
	Object.keys(present).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return present[k]; }
		});
	});
	Object.keys(projectClass).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return projectClass[k]; }
		});
	});
	Object.keys(unfinishedValidator).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return unfinishedValidator[k]; }
		});
	});
	Object.keys(unmaskHandler).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return unmaskHandler[k]; }
		});
	});
	Object.keys(valueAccessor).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return valueAccessor[k]; }
		});
	});
...
//# sourceMappingURL=taiga-ui-kit-directives.umd.js.map
