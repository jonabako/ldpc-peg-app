(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taiga-ui/cdk'), require('@taiga-ui/kit/classes'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/utils/miscellaneous', ['exports', '@taiga-ui/cdk', '@taiga-ui/kit/classes', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.utils = global["taiga-ui"].kit.utils || {}, global["taiga-ui"].kit.utils.miscellaneous = {}), global.cdk, global["taiga-ui"].kit.classes, global.rxjs, global.rxjs.operators));
})(this, (function (exports, cdk, classes, rxjs, operators) { 'use strict';
    ...
    function tuiCreateTimePeriods(minHour, maxHour, minutes) {
        ...
        var _loop_1 = function (i) {
            minutes.forEach(function (minute) {
                var time = new cdk.TuiTime(i, minute);
                timeArray.push(time);
            });
        };
    ...
    ***************************************************************************** */
    ...
    function tuiControlValueFactory(control, valueTransformer) {
        return control
            ? cdk.tuiControlValue(control).pipe(operators.map(function (value) { return valueTransformer
