(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@maskito/core'), require('@maskito/kit'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/providers'), require('@taiga-ui/kit/directives'), require('@maskito/angular')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-phone', ['exports', '@angular/core', '@angular/forms', '@maskito/core', '@maskito/kit', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/providers', '@taiga-ui/kit/directives', '@maskito/angular'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components["input-phone"] = {}), global.ng.core, global.ng.forms, global.core, global.kit, global.i2, global.i1, global["taiga-ui"].kit.providers, global["taiga-ui"].kit.directives, global.i4));
})(this, (function (exports, i0, i5, core, kit, i2, i1, providers, i3, i4) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    var TUI_INPUT_PHONE_OPTIONS = i2.tuiCreateToken(TUI_INPUT_PHONE_DEFAULT_OPTIONS);
    function tuiInputPhoneOptionsProvider(options) {
        return i2.tuiProvideOptions(TUI_INPUT_PHONE_OPTIONS, options, TUI_INPUT_PHONE_DEFAULT_OPTIONS);
    }
    ...
    function tuiCreateCompletePhoneInsertionPreprocessor(countryCode, phoneMaskAfterCountryCode) {
        ...
        var trimCountryPrefix = function (value) { return countryCode === '+7'
    ...
    var TuiInputPhoneComponent = /** @class */ (function (_super) {
        ...
        function TuiInputPhoneComponent(control, cdr, textfieldCleaner, options, textfieldSize) {
        ...
        Object.defineProperty(TuiInputPhoneComponent.prototype, "size", {
            get: function () {
        ...
        TuiInputPhoneComponent.prototype.calculateMask = function (countryCode, phoneMaskAfterCountryCode, nonRemovablePrefix, allowText) {
            ...
            return allowText
                ...
                : {
                    ...
                    preprocessors: preprocessors,
                    postprocessors: [
                        kit.maskitoPrefixPostprocessorGenerator(nonRemovablePrefix),
                    ],
                    plugins: [
                        kit.maskitoCaretGuard(function (value, _b) {
                            var _c = __read(_b, 2), from = _c[0], to = _c[1];
                            return [
