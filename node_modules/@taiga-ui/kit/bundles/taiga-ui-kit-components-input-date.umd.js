(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@maskito/core'), require('@maskito/kit'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/constants'), require('@taiga-ui/kit/tokens'), require('@tinkoff/ng-polymorpheus'), require('rxjs/operators'), require('@taiga-ui/kit/directives'), require('@maskito/angular'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-date', ['exports', '@angular/core', '@angular/forms', '@maskito/core', '@maskito/kit', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/constants', '@taiga-ui/kit/tokens', '@tinkoff/ng-polymorpheus', 'rxjs/operators', '@taiga-ui/kit/directives', '@maskito/angular', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components["input-date"] = {}), global.ng.core, global.ng.forms, global.core, global.kit, global.i2, global.i1, global["taiga-ui"].kit.constants, global["taiga-ui"].kit.tokens, global.i5, global.rxjs.operators, global["taiga-ui"].kit.directives, global.i4, global.ng.common, global.rxjs));
})(this, (function (exports, i0, i8, core, kit, i2, i1, constants, tokens, i5, operators, i3, i4, i6, i9) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiNativeDateDirective = /** @class */ (function () {
        ...
        Object.defineProperty(TuiNativeDateDirective.prototype, "max", {
            get: function () {
        ...
        Object.defineProperty(TuiNativeDateDirective.prototype, "min", {
            get: function () {
    ...
    var TuiInputDateComponent = /** @class */ (function (_super) {
        ...
        function TuiInputDateComponent(control, cdr, injector, isMobile, dialogs, mobileCalendar, dateFormat, dateSeparator, dateTexts$, valueTransformer, options, textfieldSize) {
        ...
        Object.defineProperty(TuiInputDateComponent.prototype, "computedMin", {
            get: function () {
                var _a;
        ...
        Object.defineProperty(TuiInputDateComponent.prototype, "computedMax", {
            get: function () {
                var _a;
        ...
        Object.defineProperty(TuiInputDateComponent.prototype, "computedValue", {
            get: function () {
                var _c = this, value = _c.value, nativeValue = _c.nativeValue, activeItem = _c.activeItem;
                if (activeItem) {
        ...
        Object.defineProperty(TuiInputDateComponent.prototype, "computedActiveYearMonth", {
            get: function () {
                ...
                return (this.month ||
                    this.value ||
                    i2.tuiDateClamp(this.defaultActiveYearMonth, this.computedMin, this.computedMax));
            },
            enumerable: false,
            configurable: true
        });
        ...
        TuiInputDateComponent.prototype.computeMaskOptions = function (mode, separator, min, max) {
            return kit.maskitoDateOptionsGenerator({
                separator: separator,
                mode: constants.TUI_DATE_MODE_MASKITO_ADAPTER[mode],
    ...
    var TuiInputDateDirective = /** @class */ (function (_super) {
        ...
        Object.defineProperty(TuiInputDateDirective.prototype, "max", {
            get: function () {
        ...
        Object.defineProperty(TuiInputDateDirective.prototype, "min", {
            get: function () {
    ...
    TuiInputDateModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiInputDateModule, declarations: [TuiInputDateComponent, TuiInputDateDirective, TuiNativeDateDirective], imports: [i6.CommonModule,
            i4.MaskitoModule,
