(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('@taiga-ui/kit/utils/math'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/pagination', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', '@taiga-ui/kit/utils/math', 'rxjs', 'rxjs/operators', '@angular/common', '@tinkoff/ng-polymorpheus'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components.pagination = {}), global.ng.core, global.i2, global.i1, global["taiga-ui"].kit.tokens, global["taiga-ui"].kit.utils.math, global.rxjs, global.rxjs.operators, global.ng.common, global.i4));
})(this, (function (exports, i0, i2, i1, tokens, math, i5, operators, i3, i4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiPaginationComponent = /** @class */ (function (_super) {
        ...
        function TuiPaginationComponent(el, modeDirective, texts$, icons) {
            var _this = _super.call(this) || this;
            _this.el = el;
            _this.modeDirective = modeDirective;
            _this.texts$ = texts$;
            _this.icons = icons;
            _this.els = i2.EMPTY_QUERY;
            _this.length = 1;
            _this.size = 'l';
             ...
             */
            _this.index = 0;
            _this.indexChange = new i0.EventEmitter();
            _this.mode$ = _this.modeDirective
                ? _this.modeDirective.change$.pipe(operators.map(function () { var _a; return ((_a = _this.modeDirective) === null || _a === void 0 ? void 0 : _a.mode) || null; }))
                : i5.EMPTY;
            return _this;
        }
        Object.defineProperty(TuiPaginationComponent.prototype, "nativeFocusableElement", {
            get: function () {
                ...
                return ((_b = (_a = this.els.find(function (_, index) { return index === activeElementIndex; })) === null || _a === void 0 ? void 0 : _a.nativeFocusableElement) !== null && _b !== void 0 ? _b : null);
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(TuiPaginationComponent.prototype, "focused", {
            get: function () {
                return i2.tuiIsNativeFocusedIn(this.el.nativeElement);
            },
            enumerable: false,
            configurable: true
        });
        ...
        Object.defineProperty(TuiPaginationComponent.prototype, "buttonSize", {
            get: function () {
        ...
        TuiPaginationComponent.prototype.getItemIndexByElementIndex = function (elementIndex) {
            ...
            return i2.tuiClamp(computedIndex, elementIndex, this.lastIndex - reverseElementIndex);
        };
        TuiPaginationComponent.prototype.getElementMode = function (index) {
            return this.index === index ? i1.TuiAppearance.Primary : i1.TuiAppearance.Flat;
        };
        TuiPaginationComponent.prototype.getSmallElementMode = function (index, mode) {
            return this.index === index && mode !== 'onLight'
                ? i1.TuiAppearance.Primary
                : i1.TuiAppearance.Secondary;
        };
        ...
        TuiPaginationComponent.prototype.onElementKeyDownArrowLeft = function (element) {
            ...
            var previous = this.els.find(function (_, index, array) { return array[index + 1] === element; });
        ...
        TuiPaginationComponent.prototype.onElementKeyDownArrowRight = function (element) {
            ...
            var next = this.els.find(function (_, index, array) { return array[index - 1] === element; });
        ...
        TuiPaginationComponent.prototype.tryChangeTo = function (direction) {
            this.updateIndex(i2.tuiClamp(this.index + math.tuiHorizontalDirectionToNumber(direction), 0, this.lastIndex));
        };
    ...
    TuiPaginationComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiPaginationComponent, deps: [{ token: i0.ElementRef }, { token: i1.TuiModeDirective, optional: true }, { token: tokens.TUI_PAGINATION_TEXTS }, { token: i1.TUI_SPIN_ICONS }], target: i0__namespace.ɵɵFactoryTarget.Component });
    TuiPaginationComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: TuiPaginationComponent, selector: "tui-pagination", inputs: { length: "length", size: "size", disabled: "disabled", activePadding: "activePadding", sidePadding: "sidePadding", content: "content", index: "index" }, outputs: { indexChange: "indexChange" }, providers: [i2.tuiAsFocusableItemAccessor(TuiPaginationComponent)], viewQueries: [{ propertyName: "els", predicate: ["element"], descendants: true, read: i2.TUI_FOCUSABLE_ITEM_ACCESSOR }], usesInheritance: true, ngImport: i0__namespace, template: "<div\n    class=\"t-content\"\n    (tuiActiveZoneChange)=\"onActiveZone($event)\"\n>\n    <ng-container *ngIf=\"size !== 's'; else smallButtons\">\n        <ng-container *ngIf=\"texts$ | async as texts\">\n            <button\n                appearance=\"flat\"\n                tuiIconButton\n                type=\"button\"\n                class=\"t-button\"\n                [disabled]=\"arrowIsDisabledLeft\"\n                [focusable]=\"false\"\n                [icon]=\"icons.decrement\"\n                [size]=\"buttonSize\"\n                [title]=\"texts[0]\"\n                (click)=\"onArrowClick('left')\"\n                (mousedown.silent.prevent)=\"(0)\"\n            ></button>\n            <ng-container *tuiRepeatTimes=\"let elementIndex of elementsLength\">\n                <ng-container *tuiLet=\"getItemIndexByElementIndex(elementIndex) as index\">\n                    <button\n                        *ngIf=\"index !== null; else dotsTemplate\"\n                        #element\n                        automation-id=\"tui-pagination__element\"\n                        shape=\"square\"\n                        tuiButton\n                        type=\"button\"\n                        class=\"t-button\"\n                        [appearance]=\"getElementMode(index)\"\n                        [disabled]=\"disabled\"\n                        [focusable]=\"elementIsFocusable(index)\"\n                        [size]=\"buttonSize\"\n                        (click)=\"onElementClick(index)\"\n                        (keydown.arrowLeft.prevent)=\"onElementKeyDownArrowLeft(element)\"\n                        (keydown.arrowRight.prevent)=\"onElementKeyDownArrowRight(element)\"\n                    >\n                        <ng-container *polymorpheusOutlet=\"content || index + 1 as text; context: {$implicit: index}\">\n                            {{ text }}\n                        </ng-container>\n                    </button>\n                </ng-container>\n            </ng-container>\n            <button\n                appearance=\"flat\"\n                tuiIconButton\n                type=\"button\"\n                class=\"t-button\"\n                [disabled]=\"arrowIsDisabledRight\"\n                [focusable]=\"false\"\n                [icon]=\"icons.increment\"\n                [size]=\"buttonSize\"\n                [title]=\"texts[1]\"\n                (click)=\"onArrowClick('right')\"\n                (mousedown.silent.prevent)=\"(0)\"\n            ></button>\n        </ng-container>\n    </ng-container>\n    <ng-template #smallButtons>\n        <button\n            *tuiRepeatTimes=\"let indexItem of length\"\n            #element\n            shape=\"square\"\n            tuiButton\n            type=\"button\"\n            class=\"t-button t-button_small\"\n            [appearance]=\"getSmallElementMode(indexItem, mode$ | async)\"\n            [class.t-button_active]=\"indexItem === index\"\n            [disabled]=\"disabled\"\n            [focusable]=\"elementIsFocusable(indexItem)\"\n            (click)=\"onElementClick(indexItem)\"\n            (keydown.arrowLeft.prevent)=\"onElementKeyDownArrowLeft(element)\"\n            (keydown.arrowRight.prevent)=\"onElementKeyDownArrowRight(element)\"\n        ></button>\n    </ng-template>\n    <ng-template #dotsTemplate>\n        <div\n            automation-id=\"tui-pagination__element\"\n            class=\"t-dots\"\n        ></div>\n    </ng-template>\n</div>\n", styles: [":host{font:var(--tui-font-text-s);color:var(--tui-text-01);display:block;text-align:center}.t-content{display:flex;justify-content:center}.t-button{margin:0 .125rem;flex-shrink:0}.t-button_active{background:currentColor}.t-button.t-button.t-button_small{width:.5rem;height:.5rem;margin:0}.t-button.t-button.t-button_small:not(:first-child){margin-left:.5rem}.t-dots{width:var(--tui-height-s);height:var(--tui-height-s);line-height:var(--tui-height-s);margin:0 .125rem;flex-shrink:0;color:var(--tui-text-03);text-align:center;cursor:default}.t-dots:before{content:\"\\2026\"}\n"], components: [{ type: i1__namespace.TuiButtonComponent, selector: "button[tuiButton], button[tuiIconButton], a[tuiButton], a[tuiIconButton]", inputs: ["appearance", "disabled", "icon", "iconRight", "shape", "showLoader", "size"] }], directives: [{ type: i2__namespace.TuiActiveZoneDirective, selector: "[tuiActiveZone]:not(ng-container), [tuiActiveZoneChange]:not(ng-container), [tuiActiveZoneParent]:not(ng-container)", inputs: ["tuiActiveZoneParent"], outputs: ["tuiActiveZoneChange"], exportAs: ["tuiActiveZone"] }, { type: i3__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i2__namespace.TuiRepeatTimesDirective, selector: "[tuiRepeatTimes][tuiRepeatTimesOf]", inputs: ["tuiRepeatTimesOf"] }, { type: i2__namespace.TuiLetDirective, selector: "[tuiLet]", inputs: ["tuiLet"] }, { type: i4__namespace.PolymorpheusOutletDirective, selector: "[polymorpheusOutlet]", inputs: ["polymorpheusOutlet", "polymorpheusOutletContext"] }], pipes: { "async": i3__namespace.AsyncPipe }, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiPaginationComponent, decorators: [{
                type: i0.Component,
                args: [{
                        ...
                        providers: [i2.tuiAsFocusableItemAccessor(TuiPaginationComponent)],
                    }]
            ...
            return [{ type: i0__namespace.ElementRef, decorators: [{
                            ...
                            type: i0.Inject,
                            args: [tokens.TUI_PAGINATION_TEXTS]
                    ...
                    args: ['element', { read: i2.TUI_FOCUSABLE_ITEM_ACCESSOR }]
                }], length: [{
                    type: i0.Input
                }], size: [{
                    type: i0.Input
    ...
    TuiPaginationModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiPaginationModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    TuiPaginationModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiPaginationModule, declarations: [TuiPaginationComponent], imports: [i3.CommonModule,
            i4.PolymorpheusModule,
            i2.TuiRepeatTimesModule,
            i2.TuiLetModule,
            i2.TuiActiveZoneModule,
            i1.TuiButtonModule], exports: [TuiPaginationComponent] });
    TuiPaginationModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiPaginationModule, imports: [[
                i3.CommonModule,
                i4.PolymorpheusModule,
                i2.TuiRepeatTimesModule,
                i2.TuiLetModule,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiPaginationModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [
                            i3.CommonModule,
    ...
    exports.TuiPaginationComponent = TuiPaginationComponent;
    exports.TuiPaginationModule = TuiPaginationModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=taiga-ui-kit-components-pagination.umd.js.map
