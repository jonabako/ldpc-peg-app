(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/calendar-month', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components["calendar-month"] = {}), global.ng.core, global.i3, global.i1, global["taiga-ui"].kit.tokens, global.ng.common, global.rxjs));
})(this, (function (exports, i0, i3, i1, tokens, i2, i4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TODAY = i3.TuiDay.currentLocal();
    var TuiCalendarMonthComponent = /** @class */ (function () {
        function TuiCalendarMonthComponent(months$) {
            this.months$ = months$;
            this.value = null;
            this.year = TODAY;
            this.disabledItemHandler = i3.ALWAYS_FALSE_HANDLER;
            this.min = i3.TUI_FIRST_DAY;
            this.max = i3.TUI_LAST_DAY;
            this.monthClick = new i0.EventEmitter();
        ...
        Object.defineProperty(TuiCalendarMonthComponent.prototype, "isSingle", {
            get: function () {
                return (this.value !== null &&
                    (this.value instanceof i3.TuiMonth || this.value.isSingleMonth));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(TuiCalendarMonthComponent.prototype, "computedMin", {
            get: function () {
                var _a;
        ...
        Object.defineProperty(TuiCalendarMonthComponent.prototype, "computedMax", {
            get: function () {
                var _a;
        ...
        TuiCalendarMonthComponent.prototype.getItemState = function (item) {
            var _b = this, disabledItemHandlerWithMinMax = _b.disabledItemHandlerWithMinMax, pressedItem = _b.pressedItem, hoveredItem = _b.hoveredItem;
            if (disabledItemHandlerWithMinMax(item)) {
                return i1.TuiInteractiveState.Disabled;
            }
            if (pressedItem === null || pressedItem === void 0 ? void 0 : pressedItem.monthSame(item)) {
                return i1.TuiInteractiveState.Active;
            }
            if (hoveredItem === null || hoveredItem === void 0 ? void 0 : hoveredItem.monthSame(item)) {
                return i1.TuiInteractiveState.Hover;
            }
            return null;
        };
        TuiCalendarMonthComponent.prototype.getItemRange = function (item) {
            ...
            if (value instanceof i3.TuiMonth) {
                return value.monthSame(item) ? i1.TuiRangeState.Single : null;
            }
            ...
            var hoveredItemAfterFrom = (hoveredItem === null || hoveredItem === void 0 ? void 0 : hoveredItem.monthAfter(value.from)) &&
                ...
                value.isSingleMonth;
            var hoveredItemIsCandidateToBeFrom = (hoveredItem === null || hoveredItem === void 0 ? void 0 : hoveredItem.monthSame(item)) &&
            ...
            if (theFirstOfRange || hoveredItemAfterFrom || hoveredItemIsCandidateToBeFrom) {
                return i1.TuiRangeState.Start;
            }
            var theLastOfRange = value.to.monthSame(item) && !value.isSingleMonth;
            var hoveredItemBeforeTo = value.to.monthSame(item) &&
                (hoveredItem === null || hoveredItem === void 0 ? void 0 : hoveredItem.monthBefore(value.to)) &&
                value.isSingleMonth;
            var hoveredItemIsCandidateToBeTo = (hoveredItem === null || hoveredItem === void 0 ? void 0 : hoveredItem.monthSame(item)) &&
        ...
        TuiCalendarMonthComponent.prototype.isItemInsideRange = function (month) {
            var _b = this, value = _b.value, hoveredItem = _b.hoveredItem;
            if (value === null || value instanceof i3.TuiMonth) {
                return false;
            }
            ...
            var range = i3.TuiMonthRange.sort(value.from, hoveredItem);
        ...
        TuiCalendarMonthComponent.prototype.calculateDisabledItemHandlerWithMinMax = function (disabledItemHandler, value, min, max) {
            return function (item) { return item.monthBefore(min) ||
                item.monthAfter(max) ||
        ...
        TuiCalendarMonthComponent.prototype.updateHoveredItem = function (month) {
            if (i3.tuiNullableSame(this.hoveredItem, month, function (a, b) { return a.monthSame(b); })) {
                return;
            }
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCalendarMonthComponent, decorators: [{
            ...
            return [{ type: i4__namespace.Observable, decorators: [{
                            type: i0.Inject,
                            args: [tokens.TUI_CALENDAR_MONTHS]
                        }] }];
    ...
    TuiCalendarMonthModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCalendarMonthModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    TuiCalendarMonthModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCalendarMonthModule, declarations: [TuiCalendarMonthComponent], imports: [i2.CommonModule,
            i1.TuiPrimitiveYearPickerModule,
            i1.TuiPrimitiveSpinButtonModule,
            i1.TuiScrollbarModule,
            i1.TuiLinkModule,
            i3.TuiLetModule,
            i3.TuiHoveredModule,
            i3.TuiPressedModule,
            i3.TuiFocusableModule], exports: [TuiCalendarMonthComponent] });
    TuiCalendarMonthModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCalendarMonthModule, imports: [[
                i2.CommonModule,
                i1.TuiPrimitiveYearPickerModule,
                i1.TuiPrimitiveSpinButtonModule,
                i1.TuiScrollbarModule,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCalendarMonthModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [
                            i2.CommonModule,
    ...
    exports.TuiCalendarMonthComponent = TuiCalendarMonthComponent;
    exports.TuiCalendarMonthModule = TuiCalendarMonthModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=taiga-ui-kit-components-calendar-month.umd.js.map
