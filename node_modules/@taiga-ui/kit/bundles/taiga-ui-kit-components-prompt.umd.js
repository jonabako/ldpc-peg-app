(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('@tinkoff/ng-polymorpheus'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/prompt', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', '@tinkoff/ng-polymorpheus', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components.prompt = {}), global.ng.core, global.i4, global.i1, global["taiga-ui"].kit.tokens, global.i2, global.ng.common, global.rxjs));
})(this, (function (exports, i0, i4, i1, tokens, i2, i3, i5) { 'use strict';
    ...
    var TuiPromptComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiPromptComponent.prototype, "appearance", {
            get: function () {
                return this.isMobile ? i1.TuiAppearance.Secondary : i1.TuiAppearance.Flat;
            },
            enumerable: false,
            configurable: true
        });
    ...
    var TuiPromptModule = /** @class */ (function () {
        function TuiPromptModule() {
        }
    ...
    exports.TUI_PROMPT = TUI_PROMPT;
    exports.TuiPromptComponent = TuiPromptComponent;
    exports.TuiPromptModule = TuiPromptModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=taiga-ui-kit-components-prompt.umd.js.map
