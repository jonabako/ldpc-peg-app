(function (global, factory) {
    ...
    var TuiSelectOptionComponent = /** @class */ (function () {
        function TuiSelectOptionComponent(icons, context, host, el, option, dataList, control, abstractControl) {
            var _this = this;
            this.icons = icons;
        ...
        TuiSelectOptionComponent.prototype.ngOnInit = function () {
            ...
            void Promise.resolve().then(function () {
                var _a, _b;
                if (i4.tuiIsPresent(_this.option.value) && !_this.option.disabled) {
                    (_b = (_a = _this.host).checkOption) === null || _b === void 0 ? void 0 : _b.call(_a, _this.option.value);
                }
            });
        };
    ...
    TuiSelectOptionComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSelectOptionComponent, deps: [{ token: i1.TUI_COMMON_ICONS }, { token: ngPolymorpheus.POLYMORPHEUS_CONTEXT }, { token: i1.TUI_DATA_LIST_HOST }, { token: i0.ElementRef }, { token: i1.TuiOptionComponent }, { token: i1.TuiDataListComponent, optional: true }, { token: i3.NgControl }, { token: i4.AbstractTuiControl, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Component });
