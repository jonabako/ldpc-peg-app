(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taiga-ui/cdk'), require('@taiga-ui/kit/constants')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/utils/math', ['exports', '@taiga-ui/cdk', '@taiga-ui/kit/constants'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.utils = global["taiga-ui"].kit.utils || {}, global["taiga-ui"].kit.utils.math = {}), global.cdk, global["taiga-ui"].kit.constants));
    ...
    ***************************************************************************** */
    ...
    function tuiFindKeyStepsBoundariesByFn(keySteps, fn) {
        ...
        var lowerStep = keySteps[keyStepUpperIndex - 1] || keySteps[0];
        var upperStep = keySteps[keyStepUpperIndex] || keySteps[keySteps.length - 1];
    ...
    function tuiPercentageToKeyStepValue(valuePercentage, keySteps) {
        ...
        return cdk.tuiRound(controlValue, constants.TUI_FLOATING_PRECISION);
    }
    ...
    exports.tuiHorizontalDirectionToNumber = tuiHorizontalDirectionToNumber;
    exports.tuiKeyStepValueToPercentage = tuiKeyStepValueToPercentage;
    exports.tuiPercentageToKeyStepValue = tuiPercentageToKeyStepValue;
