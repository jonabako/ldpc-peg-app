(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/kit/utils'), require('@ng-web-apis/common'), require('rxjs/operators'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/slider', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/kit/utils', '@ng-web-apis/common', 'rxjs/operators', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components.slider = {}), global.ng.core, global.ng.forms, global.cdk, global["taiga-ui"].kit.utils, global.common, global.rxjs.operators, global.ng.common, global.rxjs));
})(this, (function (exports, i0, i1, cdk, utils, common, operators, i1$2, i1$1) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    var TUI_SLIDER_OPTIONS = cdk.tuiCreateToken(TUI_SLIDER_DEFAULT_OPTIONS);
    function tuiSliderOptionsProvider(options) {
        return cdk.tuiProvideOptions(TUI_SLIDER_OPTIONS, options, TUI_SLIDER_DEFAULT_OPTIONS);
    }

    var TuiSliderComponent = /** @class */ (function () {
        function TuiSliderComponent(control, cdr, options, el, userAgent, injector) {
            var _a;
            ...
            this.segments = 1;
            if (control instanceof i1.NgModel) {
                /**
                 ...
                 */
                (_a = control.valueChanges) === null || _a === void 0 ? void 0 : _a.pipe(cdk.tuiWatch(cdr), operators.take(1)).subscribe();
            }
        }
        ...
        Object.defineProperty(TuiSliderComponent.prototype, "value", {
            get: function () {
                var _b = this, el = _b.el, control = _b.control, hasKeySteps = _b.hasKeySteps;
                if (!hasKeySteps && control instanceof i1.NgModel) {
                    /**
        ...
        Object.defineProperty(TuiSliderComponent.prototype, "valueRatio", {
            get: function () {
        ...
        Object.defineProperty(TuiSliderComponent.prototype, "isOldEdge", {
            ...
            get: function () {
                return cdk.tuiIsEdgeOlderThan(cdk.CHROMIUM_EDGE_START_VERSION, this.userAgent);
            },
            enumerable: false,
            configurable: true
        });
    ...
    var TuiSliderKeyStepsDirective = /** @class */ (function (_super) {
        ...
        function TuiSliderKeyStepsDirective(control, cdr, el, slider) {
        ...
        Object.defineProperty(TuiSliderKeyStepsDirective.prototype, "focused", {
            get: function () {
                return cdk.tuiIsNativeFocused(this.nativeFocusableElement);
            },
            enumerable: false,
            configurable: true
        });
        ...
        TuiSliderKeyStepsDirective.prototype.updateControlValue = function () {
            this.value = utils.tuiPercentageToKeyStepValue(this.slider.valuePercentage, this.keySteps);
        };
        TuiSliderKeyStepsDirective.prototype.writeValue = function (controlValue) {
            if (controlValue === null) {
                return;
            }
            var clampedControlValue = cdk.tuiClamp(controlValue, this.min, this.max);
            ngDevMode &&
                cdk.tuiAssert.assert(controlValue === clampedControlValue, '\n[SliderKeySteps]: You cannot programmatically set value which is less/more than min/max');
        ...
        TuiSliderKeyStepsDirective.prototype.transformToNativeValue = function (controlValue) {
            ...
            var newValuePercentage = utils.tuiKeyStepValueToPercentage(controlValue, this.keySteps);
            return (newValuePercentage * (max - min)) / 100 + min;
        };
        return TuiSliderKeyStepsDirective;
    }(cdk.AbstractTuiControl));
    TuiSliderKeyStepsDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderKeyStepsDirective, deps: [{ token: i1.NgControl, optional: true, self: true }, { token: i0.ChangeDetectorRef }, { token: i0.ElementRef }, { token: i0.forwardRef(function () { return TuiSliderComponent; }) }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    TuiSliderKeyStepsDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiSliderKeyStepsDirective, selector: "input[tuiSlider][keySteps]", inputs: { keySteps: "keySteps" }, host: { listeners: { "input": "updateControlValue()", "change": "updateControlValue()" }, properties: { "attr.aria-valuenow": "safeCurrentValue", "attr.aria-valuemin": "min", "attr.aria-valuemax": "max", "disabled": "computedDisabled" } }, usesInheritance: true, ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderKeyStepsDirective, decorators: [{
                type: i0.Directive,
                args: [{
            ...
            return [{ type: i1__namespace.NgControl, decorators: [{
                            ...
                            type: i0.Inject,
                            args: [i0.forwardRef(function () { return TuiSliderComponent; })]
                        }] }];
    ...
    var TuiSliderReadonlyDirective = /** @class */ (function () {
        function TuiSliderReadonlyDirective(el, doc, destroy$) {
            var _this = this;
            this.readonly = true;
            var touchStart$ = cdk.tuiTypedFromEvent(el.nativeElement, 'touchstart', {
                passive: false,
            });
            var touchMove$ = cdk.tuiTypedFromEvent(doc, 'touchmove', {
                passive: false,
            });
            var touchEnd$ = cdk.tuiTypedFromEvent(doc, 'touchend', {
                passive: true,
            });
            var shouldPreventMove$ = i1$1.merge(touchStart$.pipe(operators.tap(function (e) { return _this.preventEvent(e); }), operators.map(cdk.ALWAYS_TRUE_HANDLER)), touchEnd$.pipe(operators.map(cdk.ALWAYS_FALSE_HANDLER)));
            /**
             ...
             */
            i1$1.combineLatest([touchMove$, shouldPreventMove$])
        ...
        TuiSliderReadonlyDirective.prototype.preventEvent = function (event) {
            if (event.cancelable && cdk.tuiCoerceBooleanProperty(this.readonly)) {
    ...
    TuiSliderReadonlyDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderReadonlyDirective, deps: [{ token: i0.ElementRef }, { token: i1$2.DOCUMENT }, { token: cdk.TuiDestroyService, self: true }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    TuiSliderReadonlyDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiSliderReadonlyDirective, selector: "input[tuiSlider][readonly]", inputs: { readonly: "readonly" }, host: { listeners: { "mousedown": "preventEvent($event)", "keydown": "preventKeyboardInteraction($event)" } }, providers: [cdk.TuiDestroyService], ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderReadonlyDirective, decorators: [{
                type: i0.Directive,
                args: [{
    ...
    var TuiSliderThumbLabelComponent = /** @class */ (function () {
        ...
        TuiSliderThumbLabelComponent.prototype.ngAfterContentInit = function () {
            var _a;
            ngDevMode &&
                cdk.tuiAssert.assert(Boolean((_a = this.control) === null || _a === void 0 ? void 0 : _a.valueChanges), '\n[tuiSliderThumbLabel] expected <input tuiSlider type="range" /> to use Angular Forms.\n' +
                    'Use [(ngModel)] or [formControl] or formControlName for correct work.');
        };
        return TuiSliderThumbLabelComponent;
    }());
    TuiSliderThumbLabelComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderThumbLabelComponent, deps: [], target: i0__namespace.ɵɵFactoryTarget.Component });
    TuiSliderThumbLabelComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: TuiSliderThumbLabelComponent, selector: "[tuiSliderThumbLabel]", queries: [{ propertyName: "slider", first: true, predicate: TuiSliderComponent, descendants: true }, { propertyName: "control", first: true, predicate: i1.NgControl, descendants: true }], ngImport: i0__namespace, template: "<ng-container *ngIf=\"control?.valueChanges | async\"></ng-container>\n\n<div\n    class=\"t-ghost\"\n    [attr.data-size]=\"size\"\n    [style.--tui-slider-thumb-ratio]=\"ratio\"\n    [style.left.px]=\"ghostLeft\"\n>\n    <ng-content></ng-content>\n</div>\n\n<ng-content select=\"input[type=range]\"></ng-content>\n", styles: [":host{position:relative}.t-ghost{position:absolute;top:0;bottom:0;margin:auto;border-radius:50%;pointer-events:none}.t-ghost[data-size=s]{width:.5rem;height:.5rem;transform:translate(calc(var(--tui-slider-thumb-ratio) * -.5rem))}.t-ghost[data-size=m]{width:.75rem;height:.75rem;transform:translate(calc(var(--tui-slider-thumb-ratio) * -.75rem))}\n"], directives: [{ type: i1__namespace$2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }], pipes: { "async": i1__namespace$2.AsyncPipe }, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderThumbLabelComponent, decorators: [{
                type: i0.Component,
                args: [{
    ...
    TuiSliderModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    TuiSliderModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderModule, declarations: [TuiSliderComponent,
            TuiSliderThumbLabelComponent,
            TuiSliderKeyStepsDirective,
            TuiSliderReadonlyDirective], imports: [i1$2.CommonModule], exports: [TuiSliderComponent,
            TuiSliderThumbLabelComponent,
            TuiSliderKeyStepsDirective,
            TuiSliderReadonlyDirective] });
    TuiSliderModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderModule, imports: [[i1$2.CommonModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiSliderModule, decorators: [{
                type: i0.NgModule,
                args: [{
    ...
    exports.TUI_SLIDER_DEFAULT_OPTIONS = TUI_SLIDER_DEFAULT_OPTIONS;
    exports.TUI_SLIDER_OPTIONS = TUI_SLIDER_OPTIONS;
    exports.TuiSliderComponent = TuiSliderComponent;
    exports.TuiSliderKeyStepsDirective = TuiSliderKeyStepsDirective;
    exports.TuiSliderModule = TuiSliderModule;
    exports.TuiSliderReadonlyDirective = TuiSliderReadonlyDirective;
    exports.TuiSliderThumbLabelComponent = TuiSliderThumbLabelComponent;
    exports.tuiSliderOptionsProvider = tuiSliderOptionsProvider;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=taiga-ui-kit-components-slider.umd.js.map
