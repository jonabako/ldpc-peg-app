(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taiga-ui/cdk'), require('@angular/core'), require('@ng-web-apis/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/addon-doc/services', ['exports', '@taiga-ui/cdk', '@angular/core', '@ng-web-apis/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"]["addon-doc"] = global["taiga-ui"]["addon-doc"] || {}, global["taiga-ui"]["addon-doc"].services = {}), global.cdk, global.ng.core, global.common, global.rxjs));
})(this, (function (exports, cdk, i0, common, rxjs) { 'use strict';
    ...
    var TUI_THEME_STORAGE_KEY = cdk.tuiCreateToken(TUI_THEME_STORAGE_DEFAULT_KEY);
    var TUI_THEME_NAME = cdk.tuiCreateToken(TUI_THEME_DEFAULT_NAME);
    ...
    ***************************************************************************** */
    ...
    var TUI_THEME_NIGHT_STORAGE_KEY = cdk.tuiCreateToken(TUI_THEME_NIGHT_STORAGE_DEFAULT_KEY);
    var TUI_USE_DEFAULT_NIGHT_THEME = cdk.tuiCreateToken(true);
...
//# sourceMappingURL=taiga-ui-addon-doc-services.umd.js.map
