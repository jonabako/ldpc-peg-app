(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var getChunksFromString = function (hex, chunkSize) { return hex.match(new RegExp(".{" + chunkSize + "}", 'g')); };
    var convertHexUnitTo256 = function (hexStr) { return parseInt(hexStr.repeat(2 / hexStr.length), 16); };
    ...
    function tuiHexToRGBA(hex, alpha) {
        var _b = __read(tuiParseHex(hex, alpha), 4), r = _b[0], g = _b[1], b = _b[2], a = _b[3];
    ...
    function tuiParseHex(hex, alpha) {
        ...
        var _b = __read((_a = hexArr === null || hexArr === void 0 ? void 0 : hexArr.map(convertHexUnitTo256)) !== null && _a !== void 0 ? _a : [], 4), r = _b[0], g = _b[1], b = _b[2], a = _b[3];
        var floatAlpha = getAlphaFloat(a, alpha);
    ...
    function tuiRgbaToHex(color) {
        ...
        var alpha = ((_b = rgb === null || rgb === void 0 ? void 0 : rgb[4]) !== null && _b !== void 0 ? _b : '').toString().trim();
        var hex = rgb
    ...
    exports.tuiHexToRGBA = tuiHexToRGBA;
    exports.tuiHexToRgb = tuiHexToRgb;
    exports.tuiHsvToRgb = tuiHsvToRgb;
    exports.tuiIsValidHex = tuiIsValidHex;
    exports.tuiIsValidRgba = tuiIsValidRgba;
    exports.tuiParseColor = tuiParseColor;
    exports.tuiParseHex = tuiParseHex;
    exports.tuiRgbToHex = tuiRgbToHex;
    exports.tuiRgbToHsv = tuiRgbToHsv;
    exports.tuiRgbaToHex = tuiRgbaToHex;
