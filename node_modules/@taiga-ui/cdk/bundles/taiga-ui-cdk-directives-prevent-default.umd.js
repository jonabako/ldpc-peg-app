(function (global, factory) {
    ...
    var TuiPreventDefaultDirective = /** @class */ (function () {
        function TuiPreventDefaultDirective(el, zone, destroy$) {
            this.el = el;
            this.zone = zone;
        ...
        TuiPreventDefaultDirective.prototype.ngOnInit = function () {
            i1.fromEvent(this.el.nativeElement, this.eventName, { passive: false })
                .pipe(observables.tuiZonefree(this.zone), observables.tuiPreventDefault(), operators.takeUntil(this.destroy$))
                .subscribe();
        };
