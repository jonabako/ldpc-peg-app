(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk/classes'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/utils/miscellaneous', ['exports', '@angular/core', '@taiga-ui/cdk/classes', '@angular/forms'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].cdk = global["taiga-ui"].cdk || {}, global["taiga-ui"].cdk.utils = global["taiga-ui"].cdk.utils || {}, global["taiga-ui"].cdk.utils.miscellaneous = {}), global.ng.core, global["taiga-ui"].cdk.classes, global.ng.forms));
})(this, (function (exports, core, classes, forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function tuiArrayToggle(array, item) {
        ...
        return index === -1 ? __spreadArray(__spreadArray([], __read(array)), [item]) : tuiArrayRemove(array, index);
    }
    ...
    function tuiDistanceBetweenTouches(_a) {
    ...
    function tuiObjectFromEntries(keyValuePairs) {
        return keyValuePairs.reduce(function (obj, _a) {
            ...
            return (Object.assign(Object.assign({}, obj), (_b = {}, _b[key] = val, _b)));
        }, {});
    }
    ...
    function tuiProvideOptions(provide, options, fallback) {
        return {
            provide: provide,
            deps: [[new core.Optional(), new core.SkipSelf(), provide]],
            useFactory: function (parent) { return (Object.assign(Object.assign({}, (parent || fallback)), options)); },
        };
    }
    ...
    exports.tuiArrayRemove = tuiArrayRemove;
    exports.tuiArrayShallowEquals = tuiArrayShallowEquals;
    exports.tuiArrayToggle = tuiArrayToggle;
    exports.tuiCleanObject = tuiCleanObject;
    exports.tuiCreateOptions = tuiCreateOptions;
    exports.tuiCreateToken = tuiCreateToken;
    exports.tuiCreateTokenFromFactory = tuiCreateTokenFromFactory;
    exports.tuiDefaultSort = tuiDefaultSort;
    exports.tuiDistanceBetweenTouches = tuiDistanceBetweenTouches;
    exports.tuiEaseInOutQuad = tuiEaseInOutQuad;
    exports.tuiFlatLength = tuiFlatLength;
    exports.tuiGetOriginalArrayFromQueryList = tuiGetOriginalArrayFromQueryList;
    exports.tuiGetSwipeDirection = tuiGetSwipeDirection;
    exports.tuiIsFalsy = tuiIsFalsy;
    exports.tuiIsNumber = tuiIsNumber;
    exports.tuiIsObject = tuiIsObject;
    exports.tuiIsPresent = tuiIsPresent;
    exports.tuiIsString = tuiIsString;
    exports.tuiIsValidUrl = tuiIsValidUrl;
    exports.tuiMarkControlAsTouchedAndValidate = tuiMarkControlAsTouchedAndValidate;
    exports.tuiNullableSame = tuiNullableSame;
    exports.tuiObjectFromEntries = tuiObjectFromEntries;
    exports.tuiProvideOptions = tuiProvideOptions;
    exports.tuiUniqBy = tuiUniqBy;
