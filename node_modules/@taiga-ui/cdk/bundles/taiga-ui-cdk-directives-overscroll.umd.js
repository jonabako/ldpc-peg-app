(function (global, factory) {
    ...
    var TuiOverscrollDirective = /** @class */ (function () {
        function TuiOverscrollDirective(_b, zone, destroy$) {
            var _this = this;
            var nativeElement = _b.nativeElement;
            this.mode = 'scroll';
            observables.tuiTypedFromEvent(nativeElement, 'wheel', { passive: false })
                .pipe(operators.filter(function () { return _this.enabled; }), observables.tuiZonefree(zone), operators.takeUntil(destroy$))
            ...
            }), observables.tuiZonefree(zone), operators.takeUntil(destroy$))
                .subscribe();
        }
