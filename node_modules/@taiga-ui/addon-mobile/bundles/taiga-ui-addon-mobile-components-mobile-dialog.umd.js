(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    var TUI_MOBILE_DIALOG_OPTIONS = cdk.tuiCreateToken(TUI_MOBILE_DIALOG_DEFAULT_OPTIONS);
    function tuiMobileDialogOptionsProvider(options) {
        return cdk.tuiProvideOptions(TUI_MOBILE_DIALOG_OPTIONS, options, TUI_MOBILE_DIALOG_DEFAULT_OPTIONS);
    }
    ...
    var TuiMobileDialogService = /** @class */ (function (_super) {
        ...
        function TuiMobileDialogService() {
            ...
            _this.defaultOptions = Object.assign(Object.assign({}, i0.inject(TUI_MOBILE_DIALOG_OPTIONS)), { data: undefined });
            return _this;
        }
    ...
    TuiMobileDialogService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiMobileDialogService, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    TuiMobileDialogService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiMobileDialogService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiMobileDialogService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    TuiMobileDialogModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiMobileDialogModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    TuiMobileDialogModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiMobileDialogModule, declarations: [TuiMobileDialogComponent], imports: [i2.CommonModule, i1.TuiButtonModule, i4.TuiRippleModule, i3.PolymorpheusModule], exports: [TuiMobileDialogComponent] });
    TuiMobileDialogModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiMobileDialogModule, providers: [cdk.tuiAsDialog(TuiMobileDialogService)], imports: [[i2.CommonModule, i1.TuiButtonModule, i4.TuiRippleModule, i3.PolymorpheusModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiMobileDialogModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i2.CommonModule, i1.TuiButtonModule, i4.TuiRippleModule, i3.PolymorpheusModule],
                        declarations: [TuiMobileDialogComponent],
                        providers: [cdk.tuiAsDialog(TuiMobileDialogService)],
    ...
    exports.TUI_MOBILE_DIALOG_DEFAULT_OPTIONS = TUI_MOBILE_DIALOG_DEFAULT_OPTIONS;
    exports.TUI_MOBILE_DIALOG_OPTIONS = TUI_MOBILE_DIALOG_OPTIONS;
    exports.TuiMobileDialogComponent = TuiMobileDialogComponent;
    exports.TuiMobileDialogModule = TuiMobileDialogModule;
    exports.TuiMobileDialogService = TuiMobileDialogService;
    exports.tuiMobileDialogOptionsProvider = tuiMobileDialogOptionsProvider;
