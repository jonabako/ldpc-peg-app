(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].core = global["taiga-ui"].core || {}, global["taiga-ui"].core.pipes = global["taiga-ui"].core.pipes || {}, global["taiga-ui"].core.pipes["calendar-sheet"] = {}), global.ng.core, global.i1, global["taiga-ui"].core.tokens));
    ...
    var getMonthStartDaysOffset = function (month, firstDayOfWeek) {
        ...
        return startMonthOffsetFromSunday >= firstDayOfWeek
            ...
            : i1.DAYS_IN_WEEK - (firstDayOfWeek - startMonthOffsetFromSunday);
    };
    /**
    ...
    var getDayFromMonthRowCol = function (_a) {
        ...
        ngDevMode && i1.tuiAssert.assert(Number.isInteger(rowIndex));
        ngDevMode && i1.tuiAssert.assert(i1.tuiInRange(rowIndex, 0, 6));
        ngDevMode && i1.tuiAssert.assert(Number.isInteger(colIndex));
        ngDevMode && i1.tuiAssert.assert(i1.tuiInRange(colIndex, 0, i1.DAYS_IN_WEEK));
        var day = rowIndex * i1.DAYS_IN_WEEK +
            colIndex -
        ...
        return new i1.TuiDay(month.year, month.month, day);
    };
    ...
    var TuiCalendarSheetPipe = /** @class */ (function () {
        ...
        TuiCalendarSheetPipe.prototype.transform = function (month, showAdjacentDays) {
            ...
            for (var rowIndex = 0; rowIndex < CALENDAR_ROWS_COUNT; rowIndex++) {
                var row = [];
                for (var colIndex = 0; colIndex < i1.DAYS_IN_WEEK; colIndex++) {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCalendarSheetPipe, decorators: [{
            ...
            return [{ type: i1__namespace.TuiDayOfWeek, decorators: [{
                            type: i0.Inject,
