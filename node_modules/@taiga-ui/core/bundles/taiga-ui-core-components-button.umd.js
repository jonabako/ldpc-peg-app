(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/directives'), require('rxjs'), require('rxjs/operators'), require('@taiga-ui/core/enums'), require('@taiga-ui/core/components/svg'), require('@taiga-ui/core/components/loader'), require('@angular/common'), require('@taiga-ui/core/directives/wrapper'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/button', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/directives', 'rxjs', 'rxjs/operators', '@taiga-ui/core/enums', '@taiga-ui/core/components/svg', '@taiga-ui/core/components/loader', '@angular/common', '@taiga-ui/core/directives/wrapper', '@tinkoff/ng-polymorpheus'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].core = global["taiga-ui"].core || {}, global["taiga-ui"].core.components = global["taiga-ui"].core.components || {}, global["taiga-ui"].core.components.button = {}), global.ng.core, global.cdk, global["taiga-ui"].core.directives, global.rxjs, global.rxjs.operators, global["taiga-ui"].core.enums, global["taiga-ui"].core.components.svg, global["taiga-ui"].core.components.loader, global.ng.common, global["taiga-ui"].core.directives.wrapper, global.i5));
})(this, (function (exports, i0, cdk, i6, rxjs, operators, enums, i1, i2, i3, i4, i5) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_BUTTON_DEFAULT_OPTIONS = {
        size: 'l',
        shape: null,
        appearance: enums.TuiAppearance.Primary,
    };
    /**
     * Default parameters for button component
     */
    var TUI_BUTTON_OPTIONS = cdk.tuiCreateToken(TUI_BUTTON_DEFAULT_OPTIONS);
    function tuiButtonOptionsProvider(options) {
        return cdk.tuiProvideOptions(TUI_BUTTON_OPTIONS, options, TUI_BUTTON_DEFAULT_OPTIONS);
    }

    var TuiButtonComponent = /** @class */ (function (_super) {
        __extends(TuiButtonComponent, _super);
        function TuiButtonComponent(mode, el, options) {
            var _this = this;
            var _a;
            ...
            _this.mode$ = ((_a = _this.mode) === null || _a === void 0 ? void 0 : _a.change$) || rxjs.EMPTY;
            _this.appearance = null;
            _this.disabled = false;
            _this.shape = _this.options.shape;
            _this.showLoader = false;
            _this.size = _this.options.size;
            _this.appearance$ = _this.mode$.pipe(operators.startWith(null), operators.map(function () { return _this.computedAppearance; }), operators.distinctUntilChanged());
            return _this;
        }
        ...
        Object.defineProperty(TuiButtonComponent.prototype, "focused", {
            get: function () {
                return !this.showLoader && cdk.tuiIsNativeFocused(this.el.nativeElement);
            },
            enumerable: false,
            configurable: true
        });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiButtonComponent, decorators: [{
                ...
                args: [{
                        ...
                        providers: [cdk.tuiAsFocusableItemAccessor(TuiButtonComponent), cdk.TuiDestroyService],
                    }]
            }], ctorParameters: function () {
            return [{ type: i6__namespace.TuiModeDirective, decorators: [{
                            type: i0.Optional
                        }, {
                            type: i0.Inject,
                            args: [i6.TuiModeDirective]
    ...
    TuiButtonModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiButtonModule, declarations: [TuiButtonComponent], imports: [i3.CommonModule,
            i5.PolymorpheusModule,
            i4.TuiWrapperModule,
            i1.TuiSvgModule,
            i2.TuiLoaderModule], exports: [TuiButtonComponent] });
    TuiButtonModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiButtonModule, imports: [[
                i3.CommonModule,
                i5.PolymorpheusModule,
                i4.TuiWrapperModule,
                i1.TuiSvgModule,
...
//# sourceMappingURL=taiga-ui-core-components-button.umd.js.map
