(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ng-web-apis/common'), require('@taiga-ui/cdk'), require('@taiga-ui/core/animations'), require('@taiga-ui/core/providers'), require('@taiga-ui/core/tokens'), require('rxjs/operators'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/scroll-controls', ['exports', '@angular/core', '@ng-web-apis/common', '@taiga-ui/cdk', '@taiga-ui/core/animations', '@taiga-ui/core/providers', '@taiga-ui/core/tokens', 'rxjs/operators', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].core = global["taiga-ui"].core || {}, global["taiga-ui"].core.components = global["taiga-ui"].core.components || {}, global["taiga-ui"].core.components["scroll-controls"] = {}), global.ng.core, global.common, global.cdk, global["taiga-ui"].core.animations, global["taiga-ui"].core.providers, global["taiga-ui"].core.tokens, global.rxjs.operators, global.ng.common, global.rxjs));
})(this, (function (exports, i0, common, cdk, animations, providers, tokens, operators, i1$1, i1) { 'use strict';
    ...
    TuiScrollbarWrapperDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollbarWrapperDirective, deps: [], target: i0__namespace.ɵɵFactoryTarget.Directive });
    TuiScrollbarWrapperDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiScrollbarWrapperDirective, selector: "[tuiScrollbarWrapper]", providers: [
            {
                provide: tokens.TUI_ELEMENT_REF,
                useExisting: i0.ElementRef,
            },
        ], ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollbarWrapperDirective, decorators: [{
                type: i0.Directive,
                args: [{
    ...
    ***************************************************************************** */
    ...
    var TuiScrollbarDirective = /** @class */ (function () {
        function TuiScrollbarDirective(zone, renderer, destroy$, animationFrame$, wrapper, container, doc, el) {
            var _this = this;
            ...
            var mousedown$ = cdk.tuiTypedFromEvent(nativeElement, 'mousedown');
            var mousemove$ = cdk.tuiTypedFromEvent(this.doc, 'mousemove');
            var mouseup$ = cdk.tuiTypedFromEvent(this.doc, 'mouseup');
            var mousedownWrapper$ = cdk.tuiTypedFromEvent(this.wrapper.nativeElement, 'mousedown');
            i1.merge(mousedownWrapper$.pipe(operators.map(function (event) { return _this.getScrolled(event, 0.5, 0.5); })), mousedown$.pipe(cdk.tuiStopPropagation(), operators.switchMap(function (event) {
            ...
            i1.merge(animationFrame$.pipe(operators.throttleTime(cdk.POLLING_TIME)), cdk.tuiScrollFrom(this.element))
                .pipe(cdk.tuiZonefree(zone), operators.takeUntil(destroy$))
                .subscribe(function () {
                if (_this.tuiScrollbar === 'vertical') {
    ...
    TuiScrollbarDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollbarDirective, deps: [{ token: i0.NgZone }, { token: i0.Renderer2 }, { token: cdk.TuiDestroyService, self: true }, { token: common.ANIMATION_FRAME }, { token: tokens.TUI_ELEMENT_REF }, { token: cdk.TUI_SCROLL_REF }, { token: i1$1.DOCUMENT }, { token: i0.ElementRef }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    TuiScrollbarDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiScrollbarDirective, selector: "[tuiScrollbar]", inputs: { tuiScrollbar: "tuiScrollbar" }, providers: [cdk.TuiDestroyService], ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollbarDirective, decorators: [{
            ...
            return [{ type: i0__namespace.NgZone, decorators: [{
                            ...
                            type: i0.Inject,
                            args: [tokens.TUI_ELEMENT_REF]
                        }] }, { type: i0__namespace.ElementRef, decorators: [{
                            type: i0.Inject,
                            args: [cdk.TUI_SCROLL_REF]
    ...
    var TuiScrollControlsComponent = /** @class */ (function () {
        function TuiScrollControlsComponent(animation, zone, scrollRef, animationFrame$, mode$) {
            var _this = this;
            ...
            this.mode$ = mode$;
            this.refresh$ = this.animationFrame$.pipe(operators.throttleTime(300), operators.map(function () { return _this.scrollbars; }), operators.startWith([false, false]), operators.distinctUntilChanged(function (a, b) { return a[0] === b[0] && a[1] === b[1]; }), cdk.tuiZoneOptimized(this.zone));
        }
    ...
    TuiScrollControlsModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollControlsModule, declarations: [TuiScrollbarDirective,
            ...
            TuiScrollControlsComponent], imports: [i1$1.CommonModule, cdk.TuiLetModule], exports: [TuiScrollControlsComponent] });
    TuiScrollControlsModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollControlsModule, imports: [[i1$1.CommonModule, cdk.TuiLetModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollControlsModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1$1.CommonModule, cdk.TuiLetModule],
                        declarations: [
...
//# sourceMappingURL=taiga-ui-core-components-scroll-controls.umd.js.map
