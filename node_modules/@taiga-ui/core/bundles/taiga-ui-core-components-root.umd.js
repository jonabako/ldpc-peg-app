(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/services'), require('@taiga-ui/core/tokens'), require('rxjs'), require('rxjs/operators'), require('@taiga-ui/core/internal/svg-defs-host'), require('@taiga-ui/core/components/hints-host'), require('@tinkoff/ng-event-plugins')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/root', ['exports', '@angular/common', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/services', '@taiga-ui/core/tokens', 'rxjs', 'rxjs/operators', '@taiga-ui/core/internal/svg-defs-host', '@taiga-ui/core/components/hints-host', '@tinkoff/ng-event-plugins'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].core = global["taiga-ui"].core || {}, global["taiga-ui"].core.components = global["taiga-ui"].core.components || {}, global["taiga-ui"].core.components.root = {}), global.ng.common, global.ng.core, global.i1, global["taiga-ui"].core.services, global["taiga-ui"].core.tokens, global.rxjs, global.rxjs.operators, global["taiga-ui"].core.internal["svg-defs-host"], global["taiga-ui"].core.components["hints-host"], global.ngEventPlugins));
})(this, (function (exports, i4, i0, i1, i5, tokens, rxjs, operators, i2, i3, ngEventPlugins) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiRootComponent = /** @class */ (function () {
        function TuiRootComponent(reducedMotion, duration, dialogs, isMobile, breakpoint, isIOS, isAndroid, document, theme) {
            var _a;
            ...
            this.isMobileRes$ = this.breakpoint.pipe(operators.map(function (breakpoint) { return breakpoint === 'mobile'; }));
            this.scrollbars$ = this.dialogs.length && !this.isMobile
                ? rxjs.combineLatest(__spreadArray([], __read(this.dialogs))).pipe(operators.map(function (dialogs) { return !dialogs.some(function (_b) {
                    var length = _b.length;
                    return length;
                }); }), operators.debounceTime(0))
                : rxjs.of(!this.isMobile);
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiRootComponent, decorators: [{
                ...
                args: [{
                        ...
                        host: {
                            'data-tui-version': i1.TUI_VERSION,
            ...
            return [{ type: undefined, decorators: [{
                            type: i0.Inject,
                            args: [tokens.TUI_REDUCED_MOTION]
                            ...
                            type: i0.Inject,
                            args: [i1.TUI_IS_MOBILE]
                        }] }, { type: i5__namespace.TuiBreakpointService, decorators: [{
                            type: i0.Inject,
                            args: [i5.TuiBreakpointService]
                        }] }, { type: undefined, decorators: [{
                            type: i0.Inject,
                            args: [i1.TUI_IS_IOS]
                        }] }, { type: undefined, decorators: [{
                            ...
                            type: i0.Inject,
                            args: [tokens.TUI_THEME]
                        }] }];
        } });

    var TuiRootModule = /** @class */ (function () {
        function TuiRootModule() {
        }
        return TuiRootModule;
    }());
    TuiRootModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiRootModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    TuiRootModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiRootModule, declarations: [TuiRootComponent], imports: [i4.CommonModule,
            ngEventPlugins.EventPluginsModule,
            i1.TuiDropdownHostModule,
            i2.TuiSvgDefsHostModule,
            i3.TuiHintsHostModule,
            i1.TuiDialogHostModule,
            i1.TuiAlertHostModule,
            i1.TuiScrollControlsModule], exports: [TuiRootComponent] });
    TuiRootModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiRootModule, imports: [[
                i4.CommonModule,
                ngEventPlugins.EventPluginsModule,
                i1.TuiDropdownHostModule,
                i2.TuiSvgDefsHostModule,
                ...
                i1.TuiDialogHostModule,
                i1.TuiAlertHostModule,
                i1.TuiScrollControlsModule,
            ]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiRootModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [
                            i4.CommonModule,
    ...
    exports.TuiRootComponent = TuiRootComponent;
    exports.TuiRootModule = TuiRootModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=taiga-ui-core-components-root.umd.js.map
