(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/core/enums'), require('@taiga-ui/core/providers'), require('@taiga-ui/core/tokens'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/directives/wrapper', ['exports', '@angular/core', '@taiga-ui/core/enums', '@taiga-ui/core/providers', '@taiga-ui/core/tokens', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].core = global["taiga-ui"].core || {}, global["taiga-ui"].core.directives = global["taiga-ui"].core.directives || {}, global["taiga-ui"].core.directives.wrapper = {}), global.ng.core, global["taiga-ui"].core.enums, global["taiga-ui"].core.providers, global["taiga-ui"].core.tokens, global.rxjs));
})(this, (function (exports, i0, enums, providers, tokens, i1) { 'use strict';
    ...
    var TuiWrapperDirective = /** @class */ (function () {
        ...
        Object.defineProperty(TuiWrapperDirective.prototype, "interactiveState", {
            get: function () {
                ...
                if (this.readOnly) {
                    return enums.TuiInteractiveState.Readonly;
                }
                if (this.active) {
