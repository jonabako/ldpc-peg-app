...
import { tuiCreateTokenFromFactory, tuiCreateToken, AbstractTuiController, TuiActiveZoneDirective, TuiHoveredService, EMPTY_CLIENT_RECT, tuiPointToClientRect, tuiClamp, tuiPx, TuiDestroyService, tuiPure, tuiIfMap, tuiTypedFromEvent, tuiIsPresent, tuiZoneOptimized, tuiIsNativeFocused, TUI_PARENT_ANIMATION } from '@taiga-ui/cdk';
import * as i3$1 from '@taiga-ui/core/abstract';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: TuiHintComponent, decorators: [{
    ...
    `,
                ...
                }] }, { type: i3$1.TuiRectAccessor, decorators: [{
                    type: Inject,
