...
export declare class TuiSvgComponent {
    ...
    constructor(doc: Document, win: Window, options: TuiSvgOptions, srcInterceptors: readonly TuiSvgInterceptorHandler[] | null, tuiSanitizer: Sanitizer | null, svgService: TuiSvgService, staticRequestService: TuiStaticRequestService, sanitizer: DomSanitizer, el: ElementRef<Element>, baseHref: string);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<TuiSvgComponent, [null, null, null, { optional: true; }, { optional: true; }, null, null, null, null, null]>;
