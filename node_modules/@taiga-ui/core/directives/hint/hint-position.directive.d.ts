...
export declare class TuiHintPositionDirective extends TuiPositionAccessor {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<TuiHintPositionDirective, "[tuiHint]:not([tuiHintCustomPosition]):not(ng-container):not(ng-template)", never, { "direction": "tuiHintDirection"; }, {}, never>;
}
