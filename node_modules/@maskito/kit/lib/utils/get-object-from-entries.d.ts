 ...
 *
 */
export declare function getObjectFromEntries<K extends number | string, V>(keyValuePairs: Array<[K, V]>): Record<K, V>;
//# sourceMappingURL=get-object-from-entries.d.ts.map